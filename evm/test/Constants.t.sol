...
abstract contract Constants {
    ...
    uint256 internal constant ASSET_PRECISION = 1e6;
    uint256 internal constant YIELD_PRECISION = 1e18;
    uint256 internal constant MIN_DEPOSIT_AMOUNT = 1 * ASSET_PRECISION;
    uint256 internal constant DEPOSIT_AMOUNT = MIN_DEPOSIT_AMOUNT;
    uint256 internal constant SHARE_PRECISION = YIELD_PRECISION;
    ...
    uint256 internal constant AVALANCHE_FORK_BLOCK = 91000000;
    uint256 internal constant OPTIMISM_FORK_BLOCK = 151682527;
    uint256 internal constant POLYGON_FORK_BLOCK = 86985165;
