...
func (c *ParentVault) LogTriggerUSDCBridgedLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []USDCBridgedTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[USDCBridgedDecoded]], error) {
...
func (c *ParentVault) FilterLogsUSDCBridged(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
