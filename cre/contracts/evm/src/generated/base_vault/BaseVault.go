...
func (c BaseVault) WriteReportFromTypesAmountRecovery(
	runtime cre.Runtime,
...
func (c *BaseVault) DecodeBaseVaultEmergencyDrainDelayNotMetError(data []byte) (*BaseVaultEmergencyDrainDelayNotMet, error) {
...
func (c *BaseVault) LogTriggerDepositToStrategyFailureLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []DepositToStrategyFailureTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[DepositToStrategyFailureDecoded]], error) {
...
func (c *BaseVault) FilterLogsDepositToStrategyFailure(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerDepositToStrategySuccessLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []DepositToStrategySuccessTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[DepositToStrategySuccessDecoded]], error) {
...
func (c *BaseVault) FilterLogsDepositToStrategySuccess(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerEmergencyDrainExecutedLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []EmergencyDrainExecutedTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[EmergencyDrainExecutedDecoded]], error) {
...
func (c *BaseVault) FilterLogsEmergencyDrainExecuted(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerRebalanceWithdrawFailureLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []RebalanceWithdrawFailureTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[RebalanceWithdrawFailureDecoded]], error) {
...
func (c *BaseVault) FilterLogsRebalanceWithdrawFailure(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerUSDCBridgedLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []USDCBridgedTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[USDCBridgedDecoded]], error) {
...
func (c *BaseVault) FilterLogsUSDCBridged(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerWithdrawFromStrategyFailureLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []WithdrawFromStrategyFailureTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[WithdrawFromStrategyFailureDecoded]], error) {
...
func (c *BaseVault) FilterLogsWithdrawFromStrategyFailure(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerWithdrawFromStrategySuccessLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []WithdrawFromStrategySuccessTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[WithdrawFromStrategySuccessDecoded]], error) {
...
func (c *BaseVault) FilterLogsWithdrawFromStrategySuccess(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
