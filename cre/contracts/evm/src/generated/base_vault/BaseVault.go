...
func (c BaseVault) GetEmergencyReceiver(
	runtime cre.Runtime,
	blockNumber *big.Int,
) cre.Promise[common.Address] {
...
func (c *BaseVault) LogTriggerDonationLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []DonationTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[DonationDecoded]], error) {
...
func (c *BaseVault) FilterLogsDonation(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
...
func (c *BaseVault) LogTriggerEmergencyReceiverSetLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []EmergencyReceiverSetTopics) (cre.Trigger[*evm.Log, *bindings.DecodedLog[EmergencyReceiverSetDecoded]], error) {
...
func (c *BaseVault) FilterLogsEmergencyReceiverSet(runtime cre.Runtime, options *bindings.FilterOptions) (cre.Promise[*evm.FilterLogsReply], error) {
	if options == nil {
		return nil, errors.New("FilterLogs options are required.")
	}
	return c.client.FilterLogs(runtime, &evm.FilterLogsRequest{
