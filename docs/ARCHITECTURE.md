...
- **ParentVault** — single user entry point. Holds the underlying asset (USDC in the initial deployment), tracks epochs, and mints/burns shares. ACE-gated on user functions.
