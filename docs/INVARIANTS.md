...
| ID          | Statement                                                                                                                                                                                                              | Type            | Status    |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | --------- |
| `REBAL-001` | Rebalance state is only `NONE` or `REBALANCING`.                                                                                                                                                                       | `invariant`     | candidate |
...
| `REBAL-004` | `pendingStrategy` is set only while rebalancing and cleared on finalization.                                                                                                                                           | `invariant`     | candidate |
| `REBAL-005` | Finalization requires the current nonce and increments nonce exactly once.                                                                                                                                             | `postcondition` | candidate |
| `REBAL-006` | Active strategy changes to pending strategy only on successful finalization.                                                                                                                                           | `invariant`     | candidate |
...
| `REBAL-008` | At transaction boundaries, `s_rebalance.state` cannot be `REBALANCING` when `s_epochNonce > 1` and `s_epochs[s_epochNonce - 1].status == EXECUTING`.                                                                   | `invariant`     | candidate |
