...
- **netFlow < 0 and netWithdrawAmount < getMinAssetAmount()**: `closeEpoch` reverts atomically. The epoch remains `OPEN`, its intents remain unchanged, and later aggregate activity or cancellation can make it closable.
