...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Auditors and security reviewers | [`AUDIT_SCOPE`](./AUDIT_SCOPE.md) **(read first — defines scope and the CRE boundary)**, [`protocol/ARCHITECTURE`](./protocol/ARCHITECTURE.md), [`security/THREAT_MODEL`](./security/THREAT_MODEL.md), [`security/INVARIANTS`](./security/INVARIANTS.md), [`security/ACCESS_CONTROL_MATRIX`](./security/ACCESS_CONTROL_MATRIX.md), [`security/KNOWN_ISSUES`](./security/KNOWN_ISSUES.md), [`protocol/PATHS`](./protocol/PATHS.md), [`protocol/DECISIONS`](./protocol/DECISIONS.md), [`protocol/GAS`](./protocol/GAS.md) | Understand audit scope and boundaries, system shape, authority, assumptions, safety claims, accepted limitations, exact flows, design rationale, and accepted gas tradeoffs. |
